...
```shell
yarn add https://github.com/mobilestar2015/react-native-twilio-video-webrtc
```

#### Option B: npm

```shell
npm install https://github.com/mobilestar2015/react-native-twilio-video-webrtc --save
```
